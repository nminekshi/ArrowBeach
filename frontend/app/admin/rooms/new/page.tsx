        ...
        <div className="grid sm:grid-cols-2 gap-6">
          <div className="space-y-2">
            ...
            <div className="flex items-center gap-2">
              <input required type="text" name="price" value={formData.price} onChange={handleChange} className="w-full px-4 py-2.5 rounded-xl border border-slate-300 focus:outline-none focus:ring-2 focus:ring-blue-500 text-base" placeholder="e.g. $35/night" />
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center gap-2">
              <input type="text" name="breakfast" value={formData.breakfast} onChange={handleChange} className="w-full px-4 py-2.5 rounded-xl border border-slate-300 focus:outline-none focus:ring-2 focus:ring-blue-500 text-base" placeholder="e.g. $42/night with breakfast" />
              <div className="flex flex-col gap-1">
